...
const Form = () => {
  ...
  const [numeroEstudante, setEmail] = useState('');
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Aqui você pode redirecionar para a tela de dashboard
       navigate("/Dashboard");

    } catch (error) {
      console.error('Erro ao fazer login:', error);
      alert('Credenciais inválidas ou servidor indisponível.');
    }
  };
    ...
    <StyledWrapper>
      <form className="form_container">
        ...
        <div className="title_container">
          ...
          <span className="subtitle">Faca aqui a gestao dos usuarios do Pavilhao desportivo do ISPTEC.</span>
        </div>
        <br />
        <div className="input_container">
          ...
          <input placeholder="name@gmail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" value={numeroEstudante}
            onChange={(e) => setEmail(e.target.value)} />
        </div>
        <div className="input_container">
          <label className="input_label" htmlFor="password_field">Palavra-passe</label>
          <svg fill="none" viewBox="0 0 24 24" height={24} width={24} xmlns="http://www.w3.org/2000/svg" className="icon">
          ...
          <input placeholder="Palavra-passe" title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" value={senha}
...
font-family: "poppins";
  ...
  .logo_container {
    background-image: url("../assets/ISptec.webp");
