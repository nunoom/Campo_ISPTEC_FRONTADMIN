    ...
    <StyledWrapper>
      <form className="form_container">
        ...
        <div className="input_container">
          ...
          <input placeholder="name@gmail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" />
        </div>
        <div className="input_container">
          ...
          <input placeholder="Palavra-passe" title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" />
        </div>
